    ...
    <div className="min-h-screen px-4 py-4 md:px-8 md:py-8 lg:px-16 xl:px-32 2xl:px-64 flex flex-col gap-8">
      ...
      <div className="flex-1 flex items-center justify-center px-2 md:px-0">
        <div className="flex flex-col justify-center gap-3 md:gap-6 w-sm">
          ...
          <p className="text-[13px] md:text-sm my-4 text-center">Don't have an account?<span className="text-[#021526] font-semibold cursor-pointer"> Sign up for free</span></p>
        </div>
      </div>
    </div>
  );
